...
function defaultProducts(shopId) {
  return [
    ...
    { shop_id: shopId, name: 'Tata Salt 1kg', aliases: ['salt', 'namak', 'tata namak'], price: 22, unit: 'kg', category: 'Staples', in_stock: true },
    ...
    { shop_id: shopId, name: 'Tata Tea Premium', aliases: ['chai', 'tea', 'tata tea'], price: 160, unit: '250g', category: 'Beverages', in_stock: true },
